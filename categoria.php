                      ...
                      <div class="row">
                            ...
                            <div class="col-12 col-sm-6 col-lg-4 mb-4">
                                <div class="single-product-wrapper">
                                    ...
                                    <div class="product-img">
                                        <img src="imagens\produtos-categoria\body_produto18_zoom.jpg" alt="">
                                    </div>
                                    <!-- Descricao -->
                            ...
                            <div class="col-12 col-sm-6 col-lg-4 mb-4">
                                <div class="single-product-wrapper">
                                    <!-- Imagem do produto -->
                                    <div class="product-img">
                                        <img src="imagens\produtos-categoria\camiseta_gun_produto11_frente_b.jpg" alt="">
                                    </div>
                                    <!-- Descricao -->
                                    <div class="descricao mt-1">
                                        <a href="#">
                            ...
                            <div class="col-12 col-sm-6 col-lg-4 mb-4">
                                <div class="single-product-wrapper">
                                    <!-- Imagem do produto -->
                                    <div class="product-img">
                                        <img src="imagens\produtos-categoria\camiseta_lion_produto12_zoom.jpg" alt="">
                                    </div>
                                    <!-- Descricao -->
                                    <div class="descricao mt-1">
                                        <a href="#">
                            ...
                            <div class="col-12 col-sm-6 col-lg-4 mb-4">
                                <div class="single-product-wrapper">
                                    <!-- Imagem do produto -->
                                    <div class="product-img">
                                        <img src="imagens\produtos-categoria\camiseta_logo.jpg" alt="">
                                    </div>
                                    <!-- Descricao -->
                                    <div class="descricao mt-1">
                                        <a href="#">
                            ...
                            <div class="col-12 col-sm-6 col-lg-4 mb-4">
                                <div class="single-product-wrapper">
                                    <!-- Imagem do produto -->
                                    <div class="product-img">
                                        <img src="imagens\produtos-categoria\conjunto_pink_frente.jpg" alt="">
                                    </div>
                                    <!-- Descricao -->
                                    <div class="descricao mt-1">
                                        <a href="#">
                            ...
                            <div class="col-12 col-sm-6 col-lg-4 mb-4">
                                <div class="single-product-wrapper">
                                    <!-- Imagem do produto -->
                                    <div class="product-img">
                                        <img src="imagens\produtos-categoria\vestido_geometrico_lado.jpg" alt="">
                                    </div>
                                    <!-- Descricao -->
                                    <div class="descricao mt-1">
                                        <a href="#">
